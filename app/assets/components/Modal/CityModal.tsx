    ...
    return (
        <ReactNativeModal isVisible={mod} onBackButtonPress={onPress} onBackdropPress={onPress}>
            <View style={{ width: "90%", height: HP(60), backgroundColor: 'white', alignSelf: 'center', borderRadius: WP(4), paddingHorizontal: WP(5), paddingTop: HP(2) }}>
                <TextInput onChangeText={(e) => search(e)} placeholder={"Search City"} style={{ borderWidth: .5, height: HP(6),borderRadius:WP(3),paddingHorizontal:WP(5),borderColor:palette.maalta,fontFamily:fontFamily.light,paddingBottom:HP(2)}} />
                <FlatList
                    // padding={30}
                    numColumns={1}
                    data={city}
