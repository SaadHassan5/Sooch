...
export class LastModal extends React.Component {
    state = {
        // blood: this.props.bloodDur,
    }
    render() {
        return (
            <ReactNativeModal isVisible={this.props.mod} onBackdropPress={this.props.onPress} onBackButtonPress={this.props.onPress} style={{  }}>
                <View style={{ width: '80%', alignSelf: 'center', height: HP(33), backgroundColor: 'white' }}>
                    <View style={{ paddingHorizontal: WP(6) }}>
                        <Text style={{ ...Styles.genTxt, marginTop: HP(1), paddingLeft: WP(2) }}>Select Your Last Blood Donation Duration</Text>
                        <TouchableOpacity onPress={this.props.onPress1} style={{ ...Styles.row, marginTop: HP(2) }}>
                            <RadioButton
                        ...
                        <TouchableOpacity onPress={this.props.onPress2} style={{ ...Styles.row, marginTop: HP(1.5) }}>
                            <RadioButton
