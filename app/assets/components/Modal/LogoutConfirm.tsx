        ...
        return (
            <ReactNativeModal isVisible={this.props.mod} onBackButtonPress={this.props.onPress} onBackdropPress={this.props.onPress} style={{ margin: 0 }}>
                <View style={{ ...Styles.modView }}>
                    <Text style={{ ...Styles.pasTxt }}>Logout Confirmation</Text>
                    <Text style={{ ...Styles.emailTxt }}>{this.props.txt1}</Text>
                    <View style={{flexDirection:'row',alignItems:'center'}}>
                        <TouchableOpacity onPress={this.props.onPressOk} style={{ ...Styles.touch }}>
                        ...
                        <TouchableOpacity onPress={this.props.onPress} style={{ ...Styles.touch }}>
                            <Text style={{ ...Styles.pasTxt, fontFamily: fontFamily.semi_bold, color: '#007AFF' }}>Cancel</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </ReactNativeModal>
